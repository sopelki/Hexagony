...
**Гексагония** — это гибрид Tower Defense и симулятора управления замком, где игроку предстоит защищать свое королевство
от монстров. Для победы нужно сочетать развитие внутри стен крепости с расстановкой ловушек и
башен на поле боя.
...
* **Внутри Замка:** Внутренний двор представляет собой сетку **3x3**. Здесь игрок строит Казармы, Фермы, Кузницы и
  Алхимические лаборатории, которые дают рыцарям пассивные бонусы.
* **На Игровом Поле:** Внешний мир состоит из гексагональной сетки. Можно размещать башни в специальные слоты и
  устанавливать ловушки, чтобы остановить врага.
...
* **Прогрессия:** Улучшение урона и здоровья войск через постройки в замке.
...
* **Система данных:** Все настройки зданий, башен, ловушек, монстров, рыцарей и звуков построены на `ScriptableObjects`,
  что позволяет легко
...
* **Адаптивный интерфейс:** Игра доступна на мониторах с соотношением сторон как 16:9, так и 16:10.
...
* **Шейдеры:** В игре используются возможности современных URP шейдеров. Игра стилизована с помощью дизеринга и эффекта
  ЭЛТ-телевизора
...
2. **Экономика:** Постройте **Ферму** для повышения лимита рыцарей и **Казармы** для их найма.
3. **Оборона:** Используйте заработанное золото, чтобы поставить **Башню** или **Ловушку** для защиты периметра.
4. **Улучшения:** Также можно построить в замке **Кузницу** для увеличения урона рыцарей или **Алхимика**, который
   сделает рыцарей более живучими.
